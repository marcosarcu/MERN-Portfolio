...
import {create} from '../services/projectsServices';
                    ...
                    <form onSubmit={handleSubmit}>
                                ...
                                technologies.map((technology) => {
                                    return (
                                        <div className="form-check" key={technology._id}>
                                            ...
                                            <input className="form-check-input" type="checkbox" name={technology.name} id={technology.name} value={technology._id} onChange={handleTechnology}></input>
                                        </div>
                                    )
                                })
                            }                        
                        ...
                        <div className="form-group mt-3 mb-3">
                            <div className="form-check">
                                ...
                                <input className="form-check-input" type="checkbox" name="public" id="public" onChange={handlePublicProject} value={publicProject}></input>
                            </div>
                        </div>
